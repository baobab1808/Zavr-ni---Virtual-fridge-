                ...
                <?php if(Route::has('login')): ?>
                    <div class="">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="text-muted" style="font-weight:bold; font-size:20px; font-family:'Ribeye Marrow'">Recepti</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-muted" style="font-weight:bold; font-size:20px; font-family:'Ribeye Marrow'">Prijava</a>

                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="ml-4 text-muted" style="font-weight:bold; font-size:20px; font-family:'Ribeye Marrow'">Registriraj se</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
...
<?php /**PATH /home/vagrant/Projects_Laravel/Zavrsni2/resources/views/welcome.blade.php ENDPATH**/ ?>
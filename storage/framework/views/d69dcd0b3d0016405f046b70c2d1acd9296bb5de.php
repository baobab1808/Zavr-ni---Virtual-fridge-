...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header'); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight" style="font-weight:bold; font-size:30px; font-family:'Open Sans'">
            Uredi recept: <?php echo e($ing->title); ?>
    ...
    <div class="py-12" style="display:flex; justify-content:center; text-align:center; background-color:rgba(255, 255, 204, 0.9)">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden shadow-xl sm:rounded-lg" style="border-radius:25px;background-color:rgba(255, 204, 0, 0.55)">
                <?php echo Form::open(['id'=>'form','route' => ['proba.update', $ing->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']); ?>
                    ...
                    <tr>
                        <td>
                            <div class = "form-group">
                                ...
                                <?php echo e(Form::text('title', $ing->title, ['placeholder' => 'Naslov', 'style' => 'border-radius:25px; border: 2px solid black;'])); ?> <br/><br/>
                    ...
                    <tr>
                        <td>
                            <div class ="form-group">
                                ...
                                <?php echo e(Form::number('time', $ing->time, ['class' => 'form-control', 'placeholder'=> 'Vrijeme', 'step' => '0.1', 'style' => 'border-radius:25px; border: 2px solid black;'])); ?>
                    ...
                    <tr>
                        <td>
                            <div class ="form-group">
                                ...
                                <?php echo e(Form::number('servings', $ing->servings, ['class' => 'form-control', 'placeholder'=> 'Porcija', 'step' => '1' , 'style' => 'border-radius:25px; border: 2px solid black;'])); ?>
                ...
                <div style="text-align:center">
                    ...
                    <div class ="form-group">
                        ...
                        <?php echo e(Form::textarea('instructions', $ing->instructions, ['id'=>'editor1','class' => 'form-control', 'placeholder'=> 'Upute' ])); ?>
...
<?php endif; ?><?php /**PATH /home/vagrant/Projects_Laravel/Zavrsni2/resources/views/proba/proba_edit.blade.php ENDPATH**/ ?>
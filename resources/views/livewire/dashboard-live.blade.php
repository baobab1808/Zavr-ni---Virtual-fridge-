    ...
    @if(count($content) > 0)
        ...
        <table class="table text-center">   
            @foreach($content as $item)
                    @if(($item[2] == $kategorija || $kategorija == "---") && $vrijeme == "---")
                                ...
                                <tr> 
                                    <td style="text-aling:center; vertical-align:middle; ">
                                        <div style=" background-color:rgba(255, 255, 204, 0.9); border-radius:25px; border: 2px dashed black;">
                                            ...
                                            <h6 style ="font-size: 20px; font-family: Open Sans">Porcije: {{$item[7]}}</h6><br/>
                                            @if($item[6] == 'min')
                    ...
                    @elseif(($item[2] == $kategorija || $kategorija == "---") && $vrijeme == 20 && $item[6] == "min" && $item[5] <= 20)
                        <div style="display:block">
                            <tr> 
                                <td style="text-aling:center; vertical-align:middle; ">
                                    <div style=" background-color:rgba(255, 255, 204, 0.9); border-radius:25px; border: 2px dashed black;">
                    ...
                    @elseif(($item[2] == $kategorija || $kategorija == "---") && $vrijeme == 1 && ($item[6] == "min" || $item[6] == "h") && $item[5] > 20)
                        <div style="display:block">
                            <tr> 
                                <td style="text-aling:center; vertical-align:middle; ">
                                    <div style=" background-color:rgba(255, 255, 204, 0.9); border-radius:25px; border: 2px dashed black;">
                    ...
                    @elseif(($item[2] == $kategorija || $kategorija == "---") && $vrijeme == 2 && $item[6] == "h" && ($item[5] >=1 && $item[5] <= 2))
                        <div style="display:block">
                            <tr> 
                                <td style="text-aling:center; vertical-align:middle; ">
                                    <div style=" background-color:rgba(255, 255, 204, 0.9); border-radius:25px; border: 2px dashed black;">
                    ...
                    @elseif(($item[2] == $kategorija || $kategorija == "---") && $vrijeme == 3 && $item[6] == "h" && $item[5] <= 20)
                        <div style="display:block">
                            <tr> 
                                <td style="text-aling:center; vertical-align:middle; ">
                                    <div style=" background-color:rgba(255, 255, 204, 0.9); border-radius:25px; border: 2px dashed black;">

    ...
    <div class="py-12" style="display:flex; justify-content:center; text-align:center; background-color:rgba(255, 255, 204, 0.9)">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
            <div class=" overflow-hidden shadow-xl sm:rounded-lg" style="border-radius:25px;background-color:rgba(255, 204, 0, 0.55)">
                ...
                {!! Form::open(['id'=>'form','route' => 'proba.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                <table style="display:flex; justify-content:center; margin-top:40px; text-align:center;">
                    ...
                    <tr>
                        <td>
                            <div class ="form-group">
                                ...
                                {{Form::number('time', '', ['class' => 'form-control', 'placeholder'=> 'Vrijeme', 'step' => '0.1', 'style' => 'border-radius:25px; border: 2px solid black;'])}}
                    ...
                    <tr>
                        <td>
                            <div class ="form-group">
                                ...
                                {{Form::number('servings', '', ['class' => 'form-control', 'placeholder'=> 'Porcija', 'step' => '1' , 'style' => 'border-radius:25px; border: 2px solid black;'])}}
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <div class ="form-group">
                        ...
                        {{Form::textarea('instructions', '', ['id'=>'editor1','class' => 'form-control', 'placeholder'=> 'Upute' ])}}
                    </div>

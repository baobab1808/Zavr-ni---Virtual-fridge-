<x-jet-action-section>
    <x-slot name="title">
        <h1 style="font-weight:bold; font-size:30px; font-family:'Open Sans'">{{ __('Sesije preglednika') }}</h1>
    </x-slot>

    <x-slot name="description">
        {{ __('Upravljajte svojim aktivnim sesijama i odjavite se s njih na drugim preglednicima i uređajima.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div>
            {{ __('Ako je potrebno, možete se odjaviti sa svih ostalih sesija preglednika na svim svojim uređajima. Neke od vaših nedavnih sesija navedene su u nastavku; međutim, ovaj popis možda nije iscrpan. Ako mislite da je vaš račun ugrožen, trebali biste ažurirati i lozinku.') }}
        </div>
        ...
        <div class="d-flex mt-3">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled" style="width:400px; background-color:black; border-color:black; color:white; font-family:'Open Sans'; font-weight:bold; text-align:center;font-size:20px">
